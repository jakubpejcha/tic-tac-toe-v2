...
const Cell = ({
    ...
    return (
        <div className='board__cell-wrapper'>
            <div
                data-index={index}
                className={`board__cell-content board__cell board__cell${size}${showClassName}${currentPlayer}${takenByPlayer}${
                    winning ? ' winning' : ''
                }`}
                onClick={handleOnClick}
            />
            <div
                className={`board__cell-content board__cell--backface board__cell--backface${size}${takenByPlayer}${
                    winning ? ' winning' : ''
                }`}
            />
        </div>
